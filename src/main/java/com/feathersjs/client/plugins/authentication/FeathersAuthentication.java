...
import com.feathersjs.client.plugins.storage.InMemoryStorageProvider;
...
//        mApp.use(mOptions.tokenEndpoint, JSONObject.class);
	...
	public <J> void authenticate(AuthenticationType authType, String identifier, String password,
			final FeathersService.FeathersCallback<AuthResponse<J>> cb, final Class<J> jClass) {
